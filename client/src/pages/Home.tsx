...
import { FaPython, FaReact, FaAws, FaDocker, FaHackerrank } from "react-icons/fa";
import { SiLeetcode, SiFlask, SiPostgresql, SiTypescript } from "react-icons/si";
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section id="hero" className="min-h-screen flex items-center justify-center relative pt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col md:flex-row items-center gap-12">
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 pt-4">
              <Button size="lg" className="rounded-full px-8 text-base shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all" asChild>
                <ScrollLink to="contact" smooth={true} duration={500} offset={-64} className="cursor-pointer">
                  Contact Me <Mail className="ml-2 h-4 w-4" />
                </ScrollLink>
              </Button>
              <Button size="lg" variant="outline" className="rounded-full px-8 text-base hover:bg-accent/10" asChild>
            ...
            <div className="flex items-center justify-center md:justify-start gap-6 pt-6">
              {[
                ...
                { icon: FaHackerrank, href: "https://hackerrank.com", label: "HackerRank" },
              ].map((social) => (
                <motion.a
                  key={social.label}
                  href={social.href}
          ...
          >
            <div className="relative w-64 h-64 md:w-96 md:h-96 mx-auto">
              ...
              {/* Floating Tech Icons */}
              <motion.div animate={{ y: [0, -10, 0] }} transition={{ repeat: Infinity, duration: 4 }} className="absolute -top-4 -right-4 bg-card p-3 rounded-xl shadow-lg border border-border/50">
                <FaReact className="w-8 h-8 text-blue-400" />
              </motion.div>
              <motion.div animate={{ y: [0, 10, 0] }} transition={{ repeat: Infinity, duration: 5, delay: 1 }} className="absolute top-1/2 -left-8 bg-card p-3 rounded-xl shadow-lg border border-border/50">
                <FaPython className="w-8 h-8 text-yellow-400" />
              </motion.div>
              <motion.div animate={{ y: [0, -8, 0] }} transition={{ repeat: Infinity, duration: 3, delay: 2 }} className="absolute -bottom-4 right-1/4 bg-card p-3 rounded-xl shadow-lg border border-border/50">
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
          <ScrollLink to="about" smooth={true} duration={500} offset={-64} className="cursor-pointer text-muted-foreground hover:text-primary">
      ...
      {/* About Section */}
      <section id="about" className="py-24 bg-card/30 backdrop-blur-sm relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading title="About Me" subtitle="My journey and educational background" />
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <p>
                I am a passionate <span className="text-primary font-semibold">B.Tech Computer Science student</span> at SR University (2023–2027) with a stellar CGPA of <span className="text-foreground font-bold">8.7/10</span>.
              </p>
              <p>
                My journey in technology is driven by a curiosity to solve real-world problems. I have honed my skills as an <span className="text-primary font-semibold">AI/ML Intern at AICTE Eduskills</span>, gaining hands-on experience in building intelligent models.
              </p>
              <p>
                With strong proficiency in <span className="text-foreground font-semibold">Python, React, Flask, and PostgreSQL</span>, I bridge the gap between complex backend logic and intuitive frontend design. I am deeply enthusiastic about Cloud Computing and constantly expanding my knowledge in AWS.
              </p>
            </motion.div>
            ...
            >
              {[
                { label: "CGPA", value: "8.7/10", icon: Award, color: "text-yellow-500" },
                { label: "Experience", value: "Internship", icon: Terminal, color: "text-blue-500" },
                { label: "Projects", value: "10+", icon: Code2, color: "text-green-500" },
                { label: "Certifications", value: "AWS & Cisco", icon: Award, color: "text-purple-500" },
              ].map((stat, idx) => (
                <div key={idx} className="bg-card/50 border border-border/50 p-6 rounded-2xl text-center hover:bg-accent/5 transition-colors group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { 
                category: "Frontend", 
                icon: Layout, 
                skills: ["React.js", "TypeScript", "Tailwind CSS", "HTML5/CSS3", "Bootstrap"] 
              },
              { 
                category: "Backend", 
                icon: Server, 
                skills: ["Python", "Flask", "Node.js", "REST APIs", "SQLAlchemy"] 
              },
              { 
                category: "Database & Tools", 
                icon: Database, 
                skills: ["PostgreSQL", "MySQL", "Git & GitHub", "VS Code", "Docker"] 
              },
              { 
                category: "Core & AI", 
                icon: BrainCircuit, 
                skills: ["Data Structures", "OOPs", "Machine Learning", "NLP", "AWS Cloud"] 
              },
            ].map((domain, index) => (
              <motion.div
                key={domain.category}
            ...
            >
              <div className="md:flex items-center justify-between group">
                <div className="hidden md:block w-5/12 text-right pr-8">
                  <h3 className="text-2xl font-bold group-hover:text-primary transition-colors">AI/ML Intern</h3>
                  <p className="text-primary font-medium">AICTE Eduskills</p>
                  <p className="text-sm text-muted-foreground mt-1">Oct 2024 – Dec 2024</p>
                </div>
                ...
                <div className="md:w-5/12 pl-0 md:pl-8">
                  ...
                  <ul className="space-y-2 text-muted-foreground list-disc ml-4">
                    <li>Worked on supervised & unsupervised learning algorithms.</li>
                    <li>Conducted model evaluation and hyperparameter tuning.</li>
                    <li>Developed mini projects in Computer Vision and NLP.</li>
                    <li>Gained exposure to AWS & Azure ML services for deployment.</li>
                  </ul>
                </div>
              </div>
            </motion.div>
            ...
            {[
              {
                ...
                description: "A full-stack university communication system facilitating seamless announcements and event management. Features a scalable backend with PostgreSQL and robust authentication.",
                tags: ["React", "TypeScript", "Flask", "PostgreSQL", "Tailwind"],
                links: { github: "#", demo: "#" }
              },
              {
                title: "Hostel Management Portal",
                description: "Role-based dashboard for efficient hostel administration. Includes room booking, fee payments, and a complaint management system with a responsive UI.",
                tags: ["HTML", "Bootstrap", "JavaScript", "PHP", "MySQL"],
                links: { github: "#", demo: "#" }
              },
              {
                title: "AI Image Classifier",
                description: "Deep learning model capable of classifying images with high accuracy using Convolutional Neural Networks (CNNs). deployed as a web app.",
      ...
      <section id="certifications" className="py-24 bg-card/30 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:madhurimandala11@gmail.com" className="text-lg font-medium hover:text-primary transition-colors">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+919177134115" className="text-lg font-medium hover:text-primary transition-colors">
                      +91 91771 34115
                    </a>
                  </div>
                </div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="John Doe" {...field} className="bg-background/50 border-border/50 focus:border-primary transition-colors" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="john@example.com" {...field} className="bg-background/50 border-border/50 focus:border-primary transition-colors" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
